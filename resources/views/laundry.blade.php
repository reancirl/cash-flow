            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row">
                    <div class="flex flex-col mb-4 sm:mb-0 sm:mr-3 sm:w-1/5">
                        <div class="mb-2">
                            <a href="{{ route('transactions.create') }}?category=Laundry">
                        ...
                        <div class="p-6 flex justify-between items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('laundry') }}{{$date_from || $date_to ? '?date_from='.$date_from.'&date_to='.$date_to.'&' : '?'}}type=">
                                        <div class="dropdown-item">All Type</div>
                                    </a>
                                    <a href="{{ route('laundry') }}{{$date_from || $date_to ? '?date_from='.$date_from.'&date_to='.$date_to.'&' : '?'}}type=sales">
                                        <div class="dropdown-item">Sales only</div>
                                    </a>
                                    <a href="{{ route('laundry') }}{{$date_from || $date_to ? '?date_from='.$date_from.'&date_to='.$date_to.'&' : '?'}}type=expense">
